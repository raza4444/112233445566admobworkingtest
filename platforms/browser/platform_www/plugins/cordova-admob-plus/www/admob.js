cordova.define("cordova-admob-plus.AdMob", function(require, exports, module) { 'use strict';
...
var constants_1 = constants.AdSizeType;
...
var Banner = /** @class */ (function (_super) {
    ...
    Banner.prototype.show = function (opts) {
        ...
        return execAsync("banner_show" /* banner_show */, [
            __assign({ position: 'bottom', size: dist_1.SMART_BANNER }, opts, { adUnitID: adUnitID, id: this.state.getAdId(adUnitID) }),
        ]);
    };
...
var Interstitial = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, execAsync("interstitial_load" /* interstitial_load */, [
                            __assign({}, opts, { adUnitID: this.resolveAdUnitID(opts.id), id: AD_ID }),
                        ])];
                    case 1:
                        _a.sent();
    ...
    Interstitial.prototype.show = function () {
        return execAsync("interstitial_show" /* interstitial_show */, [{ id: AD_ID }]);
    };
    return Interstitial;
}(AdBase));
...
var RewardVideo = /** @class */ (function (_super) {
    ...
    RewardVideo.prototype.isReady = function () {
        return execAsync("reward_video_is_ready" /* reward_video_is_ready */, [{ id: AD_ID$1 }]);
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, execAsync("reward_video_load" /* reward_video_load */, [
                                __assign({}, opts, { adUnitID: adUnitID, id: AD_ID$1 }),
                            ])];
                    case 1:
                        _a.sent();
    ...
    RewardVideo.prototype.show = function () {
        return execAsync("reward_video_show" /* reward_video_show */, [{ id: AD_ID$1 }]);
    };
    return RewardVideo;
}(AdBase));
